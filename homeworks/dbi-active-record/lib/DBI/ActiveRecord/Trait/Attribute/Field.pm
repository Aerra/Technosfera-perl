...
При наличии определяет атрибут объекта как индекс. Может принимать значения C<IndexEnum>.
...
При наличии определяет атрибут объекта как автоинкрементальный. Может принимать значения 0 или 1.
...
Для атрибутов объекта с C<index> равным C<common> определяет лимит выборки по умолчнию. 
Принимает значения C<PositiveInt>.
